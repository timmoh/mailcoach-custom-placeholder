...
class MailcoachCustomPlaceholderServiceProvider extends ServiceProvider {
    ...
    protected function bootPublishables() {
        if ($this->app->runningInConsole()) {
            ...
            $this->publishes([
                __DIR__ . '/../database/migrations/' . $migrationName . '.php.stub' => database_path('migrations/' . date('Y_m_d_His',
                        time()) . '_' . $migrationName . '.php'),
            ],
    ...
    protected function bootRoutes() {
        Route::macro('mailcoachCustomPlaceholder',
    ...
    public function register() {
        ...
        $this->app->singleton('mailcoach-custom-placeholder',
            function () {
